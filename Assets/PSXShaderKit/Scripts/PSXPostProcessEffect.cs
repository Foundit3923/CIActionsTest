...
namespace PSXShaderKit
{
    public class PSXPostProcessEffect : MonoBehaviour
    {
        ...
        private Vector3 _FullscreenColorDepth = new(256, 256, 256);
        [SerializeField]
        ...
        private Vector3 _FullscreenDitherDepth = new(32, 32, 32);
        [SerializeField]
        ...
        void UpdateValues() => Shader.SetGlobalFloat("_PSX_ObjectDithering", _ColorEmulationMode == ColorEmulationMode.PerObject_Accurate ? 1 : 0);

        void OnDisable() => _IsFirstFrame = true;
