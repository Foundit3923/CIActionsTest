...
{
    public class AppeasedState : EnemyControllerState
    {
        public AppeasedState(EnemyControllerContext context, EnemyControllerStateMachine.EEnemyState estate) : base(context, estate)
        {
