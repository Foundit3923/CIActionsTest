...
{
    public class StunnedState : EnemyControllerState
    {
        public StunnedState(EnemyControllerContext context, EnemyControllerStateMachine.EEnemyState estate) : base(context, estate)
        {
        ...
        public override void UpdateState()
        {
            ...
            if (distanceToPlayer <= 2.75)
            {
                ...
                Context.MainStateSequence.Add(EnemyControllerStateMachine.EEnemyState.Appeased);
                _finished = true;
            }
        }
