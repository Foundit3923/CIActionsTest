...
{
    public class AppeaseState : EnemyControllerState
    {
        public AppeaseState(EnemyControllerContext context, EnemyControllerStateMachine.EEnemyState estate) : base(context, estate)
        {
        ...
        public override void UpdateState()
        {
            ...
            if (distanceToPlayer <= 2.75)
            {
                ...
                Context.MainStateSequence.Add(EnemyControllerStateMachine.EEnemyState.Death);
                _finished = true;
            }
        }
