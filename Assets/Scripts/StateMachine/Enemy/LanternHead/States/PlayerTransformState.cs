...
{
    public class PlayerTransformState : EnemyControllerState
    {
        public PlayerTransformState(EnemyControllerContext context, EnemyControllerStateMachine.EEnemyState estate) : base(context, estate)
        {
        ...
        public override void EnterState()
        {
            ...
            Context.Animator.SetTrigger("Convert");
            if (Context.CapturedPlayer.TryGetComponent<Zombify>(out Zombify zombifyComponent))
            {
                zombifyComponent.ConvertPlayerToZombie(Context.Self);
            }
