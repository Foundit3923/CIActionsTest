...
namespace SjenaStates
{
    public class AnimationState : EnemyControllerState
    {
        ...
        private EnemyControllerStateMachine.EEnemyState attachState = EnemyControllerStateMachine.EEnemyState.Attach;
        ...
        public override void EnterState()
        {
            ...
            if (Context.Animator != null)
            {
                ...
                else if (Context.MainStateSequence.FirstOrDefault() == attachState)
                {
                    Context.Animator.SetBool("Death", false);
                    Context.Animator.SetBool("Kill", false);
